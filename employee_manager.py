...
class EmployeeManager:
    ...
    def fill():
        return [Employee('Liutauras', 'Pamuk', 37, '2017 12 10', '2021 01 10', '867821469'),
                ...
                Employee('Renata', 'Starinskaite', 31, '2014 05 04', 'N/A', '869521467'),
    ...
    def all_existing(self):
        ...
        for i in self.employee_list:
            if i.day_of_leaving == 'N/A':
                all_existing.append([i.name, i.surname, i.age, i.employment_date, i.day_of_leaving, i.phone_number])
        print(f"Active employees:{new_line}{new_line.join(map(str, all_existing))}")
